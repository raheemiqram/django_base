...
from apps.marketing.models import Audience


class AudienceAjaxDatatableView(AjaxDatatableView):
    model = Audience
    title = 'Audience'
    ...
    column_defs = [
        ...
        {'name': 'last_execute_count', 'visible': True, },
        {'name': 'created', 'visible': True},
        {'name': 'updated', 'visible': True},
        {'name': 'created_by', 'foreign_field': 'created_by__first_name', 'visible': True},
